...
func BuildDcRequestSugBaiduMobile(rbr *request_builder.RequestBuilderRequest) *request_builder.DcRequest {
	...
	requestUrl := fmt.Sprintf("https://m.baidu.com/sugrec?wd=%s&ie=utf-8&json=1&prod=wise", url.QueryEscape(rbr.SearchWord))
