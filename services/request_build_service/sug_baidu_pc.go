...
func BuildDcRequestSugBaiduPc(rbr *request_builder.RequestBuilderRequest) *request_builder.DcRequest {
	...
	requestUrl := fmt.Sprintf("https://www.baidu.com/sugrec?pre=1&p=3&ie=utf-8&json=1&prod=pc&from=wise_web&wd=%s&req=2&csor=6", url.QueryEscape(rbr.SearchWord))
