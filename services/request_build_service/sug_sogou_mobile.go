...
func BuildDcRequestSugSogouMobile(rbr *request_builder.RequestBuilderRequest) *request_builder.DcRequest {
	...
	requestUrl := fmt.Sprintf("https://m.sogou.com/web/sugg.jsp?kw=%s", url.QueryEscape(rbr.SearchWord))
