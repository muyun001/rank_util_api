...
func BuildDcRequestSugSogouPc(rbr *request_builder.RequestBuilderRequest) *request_builder.DcRequest {
	...
	requestUrl := fmt.Sprintf("https://www.sogou.com/suggnew/ajajjson?key=%s&type=web", url.QueryEscape(rbr.SearchWord))
