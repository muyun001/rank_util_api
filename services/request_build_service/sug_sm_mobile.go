...
func BuildDcRequestSugSmMobile(rbr *request_builder.RequestBuilderRequest) *request_builder.DcRequest {
	...
	requestUrl := fmt.Sprintf("https://sugs.m.sm.cn/web?t=w&q=%s", url.QueryEscape(rbr.SearchWord))
