...
const dataFileSugSogouMobile = "./test_html/sug_sogou_mobile.html"

func TestRankExtractorSugSogouMobile(t *testing.T) {
	contents, err := ioutil.ReadFile(dataFileSugSogouMobile)
	...
	res, err := rank_extractor_service.RankExtractorSugSogouMobile(req)
